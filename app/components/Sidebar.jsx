...
const Sidebar = () => {
  return (
    <div className="flex h-full w-60 flex-col bg-gray-50 p-3 text-gray-800">
      <div className="space-y-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            name="Search"
            placeholder="Search..."
            className="border- w-full rounded-md bg-gray-100 py-2 pl-10 text-sm text-gray-800 focus:bg-gray-50 focus:outline-none"
          />
        </div>
          ...
          <ul className="space-y-1 pb-4 pt-2 text-sm">
            <li className="rounded-sm">
              ...
              >
                ...
                <span className="text-lg">Add Room</span>
              </Link>
            </li>
            <li className="rounded-sm">
              <Link
              ...
              >
                ...
                <span className="text-lg">Manage Hotel</span>
              </Link>
            </li>
            <li className="rounded-sm">
              <Link
      ...
      <div className="mt-12 flex items-center space-x-4 justify-self-end p-2">
        <img
          ...
          alt=""
          className="h-12 w-12 rounded-lg bg-gray-500"
        />
        <div>
          <h2 className="text-lg font-semibold"> Web Aid Pro</h2>
